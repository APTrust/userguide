...
* [__Demo Repository__](https://demo.aptrust.org)
...
![APTrust Quick Start Training Video thumbnail](img/quickstart.jpg "APTrust Quick Start Training Video")

[Watch the APTrust Quick Start Training Video on YouTube (opens in new window)](https://www.youtube.com/watch?v=dKekC3jHTpM){:target="_blank"} A [transcript](./APTrust-Quick-Start-Training-Video.txt) is available.
...
DART runs on Windows, Mac, and Linux. To install DART and run your first ingest job, see the [DART user guide](https://docs.aptrust.org/dart-docs/dart3/users/getting_started/).

DART allows you to test test out different bagging and uploading options through a simple point-and-click interface. Once you find the combination that works for you, you can save it as a [Workflow](https://docs.aptrust.org/dart-docs/dart3/users/workflows/), and then you can run that workflow from within DART, or from the command line. You can also incorporate DART's command-line workflows into larger scripted workflows using languages like Ruby, Python, PHP, JavaScript or even bash shell scripts.
